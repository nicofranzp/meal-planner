...
<main class="mx-auto max-w-xl p-6">
	<h1 class="text-2xl font-semibold">Add Recipe</h1>
	<a class="mt-4 inline-block text-sm underline" href="/recipes">Back to recipes</a>
	...
	>
		...
		<div class="flex items-center gap-3">
			...
			<a class="text-sm underline" href="/recipes">Cancel</a>
		</div>
	</form>
</main>
